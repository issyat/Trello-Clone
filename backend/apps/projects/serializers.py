...
class ProjectMemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'invited_by_email', 'joined_at'
        ]
...
class ProjectListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = [
            'id', 'name', 'description', 'owner_email', 'members_count',
            'background_color', 'is_private', 'is_archived', 'created_at', 'updated_at'
        ]
...
class ProjectDetailSerializer(serializers.ModelSerializer):
    ...
    owner_email = serializers.EmailField(source='owner.email', read_only=True)
    members = ProjectMemberSerializer(source='projectmembership_set', many=True, read_only=True)
    members_count = serializers.SerializerMethodField()
    ...
    class Meta:
        model = Project
        fields = [
            'id', 'name', 'description', 'owner_email', 'members', 'members_count',
            'background_color', 'background_image', 'is_private', 'is_archived',
...
class ProjectCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = [
            'name', 'description', 'background_color', 'background_image', 'is_private'
        ]
...
class ProjectUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = [
            'name', 'description', 'background_color', 'background_image', 'is_private', 'is_archived'
        ]
...
class AddMemberSerializer(serializers.Serializer):
    ...
    role = serializers.ChoiceField(
        ...
        default=ProjectMembership.EDITOR
    )
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            if user == project.owner:
                raise serializers.ValidationError("Cannot add project owner as a member.")
...
class UpdateMemberRoleSerializer(serializers.Serializer):
    ...
    def validate_role(self, value):
        ...
        if not project.can_edit(request.user):
            raise serializers.ValidationError("You don't have permission to change member roles.")
