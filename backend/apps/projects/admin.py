...
class ProjectAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'name', 'owner', 'is_private', 'is_archived', 
        'get_members_count', 'created_at'
    ]
    list_filter = [
        'is_private', 'is_archived', 'background_color', 'created_at'
    ]
    ...
    fieldsets = (
        ...
        ('Settings', {
            'fields': ('background_color', 'background_image', 'is_private', 'is_archived')
        }),
        ('Metadata', {
...
class ProjectMembershipAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user', 'project', 'role', 'invited_by', 'joined_at'
    ]
    list_filter = ['role', 'joined_at']
    search_fields = [
        'user__email', 'project__name', 'invited_by__email'
    ]
    readonly_fields = ['id', 'joined_at']
