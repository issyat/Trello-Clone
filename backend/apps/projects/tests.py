...
class ProjectModelTest(TestCase):
    ...
    def test_can_edit_method(self):
        ...
        membership = ProjectMembership.objects.get(
            project=self.project, user=self.user2
        )
...
class ProjectAPITest(APITestCase):
    ...
    def test_my_projects_endpoint(self):
        ...
        Project.objects.create(name="User2 Project", owner=self.user2)
...
class ProjectMembershipAPITest(APITestCase):
    ...
    def test_add_member_as_owner(self):
        ...
        response = self.client.post(
            f"/api/projects/{self.project.id}/add_member/", data, format="json"
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_add_member_nonexistent_user(self):
        ...
        data = {"email": "nonexistent@example.com", "role": "editor"}
    ...
    def test_member_management_unauthorized(self):
        ...
        data = {"email": "admin@example.com", "role": "editor"}
