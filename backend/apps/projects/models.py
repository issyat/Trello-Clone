...
class Project(models.Model):
    ...
    is_private = models.BooleanField(
        default=True,
        help_text="Whether the project is private or public"
    )
    ...
    def can_edit(self, user):
        ...
        return user == self.owner or self.projectmembership_set.filter(
            user=user, 
            role__in=[ProjectMembership.ADMIN, ProjectMembership.EDITOR]
        ).exists()
