...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-1fli)@wfv*z9!h=#n+%&p_e1xcy@6n_d^lt2@54i17kj3k3q+d")
...
DATABASES = {
    "default": {
        ...
        "USER": config('DB_USER', default='trello_user'),
        "PASSWORD": config('DB_PASSWORD', default='trello_password'),
